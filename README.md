...
Application made with JavaScript, where there is an input that will be typed a value. Each value entered will return a phrase from the Dragon Ball Z character Vegeta as an answer
